...
R.id.constraint_layout -> findViewById<View>(R.id.constraint_layout).setBackgroundResource(R.color.my_red)
...
val constraint_layout = findViewById<ConstraintLayout>(R.id.constraint_layout)
        ...
        val clickableViews: List<View> =
            listOf(
                ...
                redButton, greenButton, yellowButton,constraint_layout
            )
